                            ...
                            child: DecoratedBox(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(property.qualitify.toString(),style: const TextStyle(color: Colors.white,
      ...
      child: SizedBox.fromSize(
        ...
        child: DecoratedBox(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Text('€ ${property.price.toStringAsFixed(3)}/Month', style: const TextStyle(color: Colors.white), ),
            ],
          ),
          ),
      ),
